...
/**
 * Customized Product - 01864xxMenxxx
 * Product Customizer
 *
 * @author QCao
 * @author Jmadrigal
...
class CustomProduct extends CustomProductTemplate {
    ...
    public function configureForm() {
        ...
        $this->formidable->setFormAttribute('id', '01864xxMENxxx_form');
    ...
    private function setupProductStep1() {
        ...
        if($this->CI->user->national_account){
			$page->add('phone', 'Phone', 'text', '', array('phone' => 'full'), array('field_after' => '<br><i>Ex: 555-111-2233</i>'));   
            $page->addNote('Enter a specific phone number in the format shown, or click <b>Create</b> to generate your product with generic text.');
        }                              
    }
